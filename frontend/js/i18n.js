...
const TRANSLATIONS = {
  en: {
    ...
    sharedBy: "Shared by",
    roomsSubtitle: "Collaborate and share study materials with your classmates.",
    create: "Create",
    cancel: "Cancel",
    join: "Join",
    subjectsSubtitle: "Organize your documents by course or subject.",
    noSubjects: "No subjects yet",
    noSubjectsHint: "Create your first subject above to start organizing.",
    subjectNameEmpty: "Please enter a subject name.",
    subjectNameExists: "A subject with this name already exists.",
    subjectCreateFail: "Failed to create subject.",
    subjectCreated: "Subject created!",
    subjectDeleteFail: "Failed to delete.",
    subjectDeleted: "Subject deleted.",
    subjectUpdateFail: "Failed to update.",
  ...
  mm: {
    ...
    sharedBy: "မျှဝေသူ",
    roomsSubtitle: "သင့်အတန်ဖော်များနှင့် စာလေ့လာပစ္စည်းများ မျှဝေပါ။",
    create: "ဖန်တီးမည်",
    cancel: "ပယ်ဖျက်မည်",
    join: "ဝင်မည်",
    subjectsSubtitle: "သင်ခန်းစာ သို့မဟုတ် ဘာသာရပ်အလိုက် စီစဉ်ပါ။",
    noSubjects: "ဘာသာရပ်မရှိသေးပါ",
    noSubjectsHint: "အပေါ်မှ ဘာသာရပ်အသစ်ဖန်တီးပါ။",
    subjectNameEmpty: "ဘာသာရပ်အမည်ထည့်ပါ။",
    subjectNameExists: "ဤအမည်ဖြင့် ဘာသာရပ်ရှိပြီးသားပါ။",
    subjectCreateFail: "ဘာသာရပ်ဖန်တီး၍မရပါ။",
    subjectCreated: "ဘာသာရပ်ဖန်တီးပြီးပါပြီ!",
    subjectDeleteFail: "ဖျက်၍မရပါ။",
    subjectDeleted: "ဘာသာရပ်ဖျက်ပြီးပါပြီ။",
    subjectUpdateFail: "ပြင်ဆင်၍မရပါ။",
    subjectUpdated: "ဘာသာရပ်ပြင်ဆင်ပြီးပါပြီ။",
  }
};
